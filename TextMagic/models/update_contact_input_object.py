...
class UpdateContactInputObject(object):
    ...
    def lists(self):
        ...
        Comma-separated [list](https://docs.textmagic.com/#section/Lists) ID. Each contact must be assigned to at least one list.  # noqa: E501
    ...
    def custom_field_values(self):
        """Gets the custom_field_values of this UpdateContactInputObject.  # noqa: E501
    ...
    def custom_field_values(self, custom_field_values):
        """Sets the custom_field_values of this UpdateContactInputObject.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateContactInputObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateContactInputObject):
            return False
