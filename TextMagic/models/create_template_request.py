...
class CreateTemplateRequest(BaseModel):
    ...
    content: Optional[StrictStr] = Field(default=None, description="Template text. May contain dynamic fields inside braces. See [Custom fields list](https://docs.textmagic.com/#tag/Templates/Custom-fields-list-(Merge-dynamic-fields)).")
