...
class AssignContactsToListInputObject(object):
    ...
    def __init__(self, contacts=None):  # noqa: E501
        """AssignContactsToListInputObject - a model defined in Swagger"""  # noqa: E501
    ...
    def contacts(self):
        ...
        Comma-separated array of [Contacts](https://docs.textmagic.com/#tag/Contacts) IDs.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AssignContactsToListInputObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssignContactsToListInputObject):
            return False
