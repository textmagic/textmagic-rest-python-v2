...
class DeleteContactsFromListRequest(BaseModel):
    """
    DeleteContactsFromListRequest
    """ # noqa: E501
    contacts: Optional[StrictStr] = Field(default=None, description="Comma-separated array of [Contacts](https://docs.textmagic.com/#tag/Contacts) IDs. ")
