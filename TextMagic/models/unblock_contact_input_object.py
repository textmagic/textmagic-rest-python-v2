...
class UnblockContactInputObject(object):
    ...
    def __init__(self, phone=None):  # noqa: E501
        """UnblockContactInputObject - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UnblockContactInputObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UnblockContactInputObject):
            return False
