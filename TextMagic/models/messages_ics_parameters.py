...
class MessagesIcsParameters(BaseModel):
    """
    MessagesIcsParameters
    """ # noqa: E501
    text: StrictStr = Field(description="Scheduled message text.")
    recipients: MessagesIcsParametersRecipients
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["text", "recipients"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "recipients": MessagesIcsParametersRecipients.from_dict(obj["recipients"]) if obj.get("recipients") is not None else None
        })
