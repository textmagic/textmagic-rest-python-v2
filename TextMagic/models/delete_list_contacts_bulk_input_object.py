...
class DeleteListContactsBulkInputObject(object):
    ...
    def __init__(self, ids=None, all=None):  # noqa: E501
        """DeleteListContactsBulkInputObject - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeleteListContactsBulkInputObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteListContactsBulkInputObject):
            return False
