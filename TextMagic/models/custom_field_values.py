...
class CustomFieldValues(BaseModel):
    ...
    field_title: Optional[StrictStr] = Field(default=None, alias="fieldTitle")
    field_type: Optional[StrictStr] = Field(default=None, alias="fieldType")
    value: Optional[Dict[str, Any]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["fieldId", "fieldTitle", "fieldType", "value"]
