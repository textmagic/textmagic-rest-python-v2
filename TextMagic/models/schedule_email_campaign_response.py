...
class ScheduleEmailCampaignResponse(BaseModel):
    """
    ScheduleEmailCampaignResponse
    """ # noqa: E501
    campaign: ScheduledEmailCampaignDetails
    cost: Union[StrictFloat, StrictInt] = Field(description="Estimated cost for sending this campaign.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["campaign", "cost"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "campaign": ScheduledEmailCampaignDetails.from_dict(obj["campaign"]) if obj.get("campaign") is not None else None,
            "cost": obj.get("cost")
        })
