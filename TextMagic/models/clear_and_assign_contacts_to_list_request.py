...
class ClearAndAssignContactsToListRequest(BaseModel):
    """
    ClearAndAssignContactsToListRequest
    """ # noqa: E501
    contacts: Optional[StrictStr] = Field(default=None, description="Contact ID(s), separated by a comma or \"all\" to add all contacts belonging to the current user.")
