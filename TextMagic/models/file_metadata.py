...
class FileMetadata(BaseModel):
    ...
    FileMetadata
    """ # noqa: E501
    type: StrictStr = Field(description="File metadata type.")
    height: StrictInt
    width: StrictInt
    preview: Optional[FileMetadataPreview]
    __properties: ClassVar[List[str]] = ["type", "height", "width", "preview"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "width": obj.get("width"),
            "preview": FileMetadataPreview.from_dict(obj["preview"]) if obj.get("preview") is not None else None
        })
        return _obj
