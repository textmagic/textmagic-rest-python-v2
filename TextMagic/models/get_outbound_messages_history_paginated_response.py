...
class GetOutboundMessagesHistoryPaginatedResponse(BaseModel):
    """
    GetOutboundMessagesHistoryPaginatedResponse
    """ # noqa: E501
    last_id: Optional[StrictInt] = Field(alias="lastId")
    next_last_id: StrictInt = Field(alias="nextLastId")
    limit: StrictInt = Field(description="The number of results per page.")
    resources: List[MessageOut]
    __properties: ClassVar[List[str]] = ["lastId", "nextLastId", "limit", "resources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nextLastId": obj.get("nextLastId"),
            "limit": obj.get("limit"),
            "resources": [MessageOut.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
        return _obj
