...
class ResourceLinkResponse(object):
    ...
    def __init__(self, id=None, href=None):  # noqa: E501
        """ResourceLinkResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResourceLinkResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourceLinkResponse):
            return False
