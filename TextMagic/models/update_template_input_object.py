...
class UpdateTemplateInputObject(object):
    ...
    def __init__(self, name=None, content=None):  # noqa: E501
        """UpdateTemplateInputObject - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateTemplateInputObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateTemplateInputObject):
            return False
