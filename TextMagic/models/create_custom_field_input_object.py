...
class CreateCustomFieldInputObject(object):
    ...
    def __init__(self, name=None):  # noqa: E501
        """CreateCustomFieldInputObject - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateCustomFieldInputObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCustomFieldInputObject):
            return False
