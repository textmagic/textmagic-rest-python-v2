...
class CreateContactNoteInputObject(object):
    ...
    def __init__(self, note=None):  # noqa: E501
        """CreateContactNoteInputObject - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateContactNoteInputObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateContactNoteInputObject):
            return False
