...
class DeleteChatsBulkInputObject(object):
    ...
    def status(self):
        ...
        Default is an empty string. If set, all entities with specified status will be affected.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeleteChatsBulkInputObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteChatsBulkInputObject):
            return False
