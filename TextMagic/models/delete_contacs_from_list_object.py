...
class DeleteContacsFromListObject(object):
    ...
    def __init__(self, contacts=None):  # noqa: E501
        """DeleteContacsFromListObject - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeleteContacsFromListObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteContacsFromListObject):
            return False
