...
class DeleteMessageSessionsBulkInputObject(object):
    ...
    def __init__(self, ids=None, all=None):  # noqa: E501
        """DeleteMessageSessionsBulkInputObject - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def all(self):
        """Gets the all of this DeleteMessageSessionsBulkInputObject.  # noqa: E501

        Default is 0 (false). If set to 1, all the entities will be removed.  # noqa: E501

        :return: The all of this DeleteMessageSessionsBulkInputObject.  # noqa: E501
        :rtype: int
        """
        return self._all
    ...
    @all.setter
    def all(self, all):
        """Sets the all of this DeleteMessageSessionsBulkInputObject.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeleteMessageSessionsBulkInputObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteMessageSessionsBulkInputObject):
            return False
