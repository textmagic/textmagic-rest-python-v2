...
class UpdateContactNoteInputObject(object):
    ...
    def __init__(self, note=None):  # noqa: E501
        """UpdateContactNoteInputObject - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateContactNoteInputObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateContactNoteInputObject):
            return False
